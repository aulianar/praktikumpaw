        ...
        <div class="row">
            ...
            <div class="col-4 my-4">
                ...
                <form class="d-flex" action="/mahasiswa/cari" method="GET">
                    <input name="cari" class="form-control me-2" type="text" name="cari" placeholder="Cari data mahasiswa.." value="{{ old('cari') }}">
            ...
            <div class="table-responsive">
                {{-- pemberitahuan jika anda tidak ditemukan --}}
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/mahasiswa/delete/{{$mhs->id}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Dihapus?')">Delete</a>
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('add.mhs') }}" method="POST">{{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Alamat</label> <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                    </div>
